...
for module in base ssh cli runtimes zsh neovim terminal-tools ghostty axidev-osk kanata kanata-kde handy tailscale agents dotfiles cursor-theme kde-plasma authentication; do
