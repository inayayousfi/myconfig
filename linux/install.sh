...
for module in base cachyos ssh cli runtimes zsh neovim terminal-tools tmux ghostty axidev-osk kanata kanata-kde handy tailscale docker agents dotfiles cursor-theme refind kde-plasma authentication; do
