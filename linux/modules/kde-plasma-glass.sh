...
install_kde_plasma_glass() {
    ...
    [[ -r "$data_dir/effect-id" ]] || { myconfig_fail "Glass package has no effect identifier"; return 1; }
    effect_id="$(<"$data_dir/effect-id")"
    [[ "$effect_id" == myconfig_glass_* ]] || { myconfig_fail "Invalid Glass effect identifier: $effect_id"; return 1; }
